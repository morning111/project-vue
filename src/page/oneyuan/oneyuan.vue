    ...
    <div class="city-outer">
      <div class="city-container">
        <ul class="city-list flexbox">
          <li v-for='(item, index) in cityInfo' :key='item.title' class="city-item flexbox-layout city-actived">
    ...
    <div class="anchor-outer">
      <div class="anchor-container">
        <ul class="anchor-list"  :options="anchorOption">
          <li v-for='(item, index) in anchorInfo' :key='item.id' class="anchor-item anchor-actived">
        ...
        <div class="modules-content">
          <div class="grab-outer">
            <ul class="grid-list clrfix">
              <li v-for='(item, index) in modulesInfo' :key='item.id' class="grid-item" style="float:left">
